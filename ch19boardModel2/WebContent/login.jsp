...
<html>
	...
	<body>
		<div id="member">
			<section class="login">		
				<form action="/ch19boardModel2/member/login.do" method="post">
					<table>
						<tr>
							<td><img src="/ch19boardModel2/img/login_ico_id.png" alt="아이디" /></td>
							<td><input type="text" name="uid" required placeholder="아이디 입력" autocomplete="off" /></td>
						</tr>
						<tr>
							<td><img src="/ch19boardModel2/img/login_ico_pw.png" alt="비밀번호" /></td>
				...
				<div class="info">
					...
					<div><a href="/ch19boardModel2/member/terms.do">회원가입</a></div>
				</div>			
			</section>
		</div>
